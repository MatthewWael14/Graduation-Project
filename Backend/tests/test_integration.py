...
def test_risk_engine_topology():
    ...
    check("query_context" in nodes, "Node 'query_context' registered")
    check("analyze_risk" in nodes, "Node 'analyze_risk' registered")
    check("router" in nodes, "Node 'router' registered")
    check("alert_generator" in nodes, "Node 'alert_generator' registered")
    check("validator" in nodes, "Node 'validator' registered")
